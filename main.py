...
def attack(char_name: str, char_class: str) -> str:
    """Выводит сообщение о результативности атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит сообщение о результативности защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит сообщение о результативности спецдействия."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Метод для выбора пользователем типа персонажа."""
    approve_choice: str = ''
    char_class: str = ''
